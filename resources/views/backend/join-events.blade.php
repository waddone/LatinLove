                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <table id="datatable_dance_classes" class="display dt-responsive nowrap bulk_action" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs hidden-sm" valing="top">Image</th>
                            ...
                            <script>
                                $(document).ready(function() {
                                    var table = $('#datatable_dance_classes').DataTable( {
                                        ...
                                        "ajax": "<?=url('/')?>/datatables/datatable-join-events",
                                        "columns": [
                                            { "data": "image" },
                                            { "data": "name" },
                                            { "data": "date" },
                                        ...
                                        "columnDefs": [     
                                            ...
                                            { className: "no-sort xs-text-left sm-text-left", "targets": [ 4 ], "orderable": false },
