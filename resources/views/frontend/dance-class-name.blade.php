        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-8 descriptionEverywhere">
                ...
                <div class="shareDiv">
                    ...
                    <div class="TwDiv">
                        <a href="http://www.twitter.com/share?url=<?=Route::currentRouteName();?>&text=<?=$danceClass_r->name?>" class="twitter-share-button" data-show-count="true">Tweet</a>
